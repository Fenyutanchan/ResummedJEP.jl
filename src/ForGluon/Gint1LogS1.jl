function    Gint1LogS1(ej, r, AlphaS)
    ...
    result  =   - (
        AlphaS * CA * (
            ...
            46080 * r6 * (-448 +208 * r2 -28 * r4 + r6) * Li2(0.5 + 2/r2) +     
            46080 * r6 * (-448 +208 * r2 -28 * r4 + r6) * Li2(1 + r2/4) +
            20643840 * r6 * Li2((4 + r2)/8) -     
            9584640 * r8 * Li2((4 + r2)/8) +     
            1290240 * r10 * Li2((4 + r2)/8) -     
            46080 * r12 * Li2((4 + r2)/8)
        )
    )/(288 * ej * pi * (4 + r2)^8)
