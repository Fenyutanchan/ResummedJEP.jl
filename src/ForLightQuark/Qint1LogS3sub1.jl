function Qint1LogS3sub1(ej, r, AlphaS)
    ...
    result  =   -(
        AlphaS * CF * (4 + r2)^4 * (
            ...
            Li2(0.5 - r2/8))/(4 + r2)^10 +    
            (180 * (-4 + r2)^8 * cosrP3 *    
            Li2(-(-4 + r2)^2/(16 * r2)))/(4 + r2)^8 +    
            (36 * (-4 + r2)^7 * cosrP3 *    
            Li2(-(-4 + r2)^2/(16 * r2)))/(4 + r2)^7 -    
            (360 * (-4 + r2)^6 * cosrP3 *    
            Li2(-(-4 + r2)^2/(16 * r2)))/(4 + r2)^6 -    
            (18 * (-4 + r2)^5 * cosrP3 *    
            Li2(-(-4 + r2)^2/(16 * r2)))/(4 + r2)^5 +    
            (216 * (-4 + r2)^4 * cosrP3 *    
            Li2(-(-4 + r2)^2/(16 * r2)))/(4 + r2)^4 -    
            (54 * (-4 + r2)^3 * cosrP3 *    
            Li2(-(-4 + r2)^2/(16 * r2)))/(4 + r2)^3 +    
            (360 * (-4 + r2)^9 * cosrP4 *    
            Li2(-(-4 + r2)^2/(16 * r2)))/(4 + r2)^9 +    
            (72 * (-4 + r2)^8 * cosrP4 *    
            Li2(-(-4 + r2)^2/(16 * r2)))/(4 + r2)^8 -    
            (720 * (-4 + r2)^7 * cosrP4 *    
            Li2(-(-4 + r2)^2/(16 * r2)))/(4 + r2)^7 -    
